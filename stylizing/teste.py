...
html_file = "teste_with_description_skills.html"
...
def generate_html(student_data, completed_projects, html_file):
    env = Environment(loader=FileSystemLoader('.'))
...
def generate_portfolio():
    ...
    html = generate_html(student_data, completed_projects, html_file)
    return html
	# return 'Portfolio generated.'
